## ----------------------------------------------------------------------------
## Name         prepare_var_from_nc_point_output (in R)
## Written      Pallav Kumar Shrestha, 2022/06/21
## Copyright    CC BY 4.0
## Purpose      Module that extracts a variable from mHM nc point output
...
prepare_var_from_nc_point_output <- function( file, var, daily_flag = TRUE ){
